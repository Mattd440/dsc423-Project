...
model2_2 = lm(data=train_df, formula = log(Chance.of.Admit/(1-Chance.of.Admit)) ~CGPA + GRE.Score + LOR + Research+TOEFL.Score +University.Rating + I(CGPA^2) + I(GRE.Score^2) + I(LOR^2) + I(TOEFL.Score^2)+I(University.Rating^2))
